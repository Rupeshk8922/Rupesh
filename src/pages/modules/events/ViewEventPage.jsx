...
import { format } from 'date-fns';import { Badge } from '@/components/ui/badge';import { Card, CardHeader, CardTitle, CardContent } from '@/components/ui/card';
...
const EventDetailsPage = () => {
 const { eventId } = useParams();
  ...
  // Badge variant mapping for status display
  const badgeVariant = {
    upcoming: 'default',
    completed: 'success',
