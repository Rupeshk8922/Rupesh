...
import LeadsList from '../components/leads/LeadsList'; // Make sure this path is correct
  ...
  useEffect(() => {
    if (users && Array.isArray(users)) {
      const filteredUsers = users.filter(u =>
        ['Outreach Officer', 'Telecaller', 'Manager'].includes(u.role)
      );
